-- Monte uma query usando o MOD juntamente com o IF para descobrir se o valor 15 é par ou ímpar. Chame essa coluna de 
-- ‘Par ou Ímpar’, onde ela pode dizer ‘Par’ ou ‘Ímpar’.
...
SELECT round(15 + (RAND()* 5)); -- minha resposta
SELECT FLOOR(15 + (RAND() * 5)); -- resposta do course
